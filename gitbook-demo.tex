...
\hypersetup{
  pdftitle={How to Scale AI in the Enterprise},
  pdfauthor={dr. Hicham Zmarrou},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{How to Scale AI in the Enterprise}
\author{\href{https://www.linkedin.com/in/hzmarrou/}{dr. Hicham Zmarrou}}
\date{2023-03-08}
...
\includegraphics{./img/entepriseai-model.png}
